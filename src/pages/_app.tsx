...
const suffixTitle = "Burhanuddin || Software Engineer";
...
const MyApp = ({ Component, pageProps }: AppProps) => {
  ...
  const newDescription =
    description ||
    "Software Engineer - Full Stack Developer | Javascript Developer | MEAN Stack Developer | MERN Stack Developer | Nodejs Developer | Nodejs Developer | Frontend Developer | Backend Developer";
