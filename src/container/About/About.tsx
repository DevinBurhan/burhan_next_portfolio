      ...
      <div className={`w-full ${style["app__about-container"]} 2xl:w-4/5`}>
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          <div className={`flex flex-col justify-center gap-2 ${style["p-text-lg"]}`}>
            <p>
              My name is <strong className="text-primary">Burhanuddin</strong>. Having{" "}
              ...
              for my work. From <strong className="text-primary">pixels</strong> to{" "}
              <strong className="text-primary">databases</strong>, I tackle web development
              challenges with precision and creativity Able to work independently, as a part of team
              and able to vaporize and grasp the new things. Extensive experience in working with{" "}
              <strong className="text-primary">Frontend technologies more effieciently</strong>. I
              always love to learning new things and{" "}
