...
const abouts = [
  {
    ...
    description:
      "I am a Frontend developer with a passion for developing flexible web applications. I have a strong Knowledge in HTML, CSS, JavaScript, Reactjs and Nodejs.",
    imgUrl: images.about01,
  },
  {
    title: "Backend Developer",
    description:
      "I am a Backend developer with a passion for developing flexible backend services. I have a strong Knowledge in Nodejs, Expressjs, Nestjs and MongoDB.",
